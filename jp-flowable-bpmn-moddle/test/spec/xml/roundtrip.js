...
describe('import -> export roundtrip', function() {
  ...
  describe('should keep flowable attributes', function() {

    it('flowable:FormData', validateExport('test/fixtures/xml/userTask-flowable-formData.bpmn'));

    it('flowable:InputOutput', validateExport('test/fixtures/xml/inputOutput-nestedList.bpmn'));
